...
module.exports = class Router extends express.Router {
  ...
  constructor (options) {
    ...
    this.use('/cloud-explorer/fonts', express.static(Path.resolve(nodeModulesPath, 'font-awesome/fonts/')));
    this.use('/cloud-explorer/fonts', express.static(Path.resolve(nodeModulesPath, 'npm-font-open-sans/fonts/')));
