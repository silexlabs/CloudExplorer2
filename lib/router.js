...
module.exports = class Router extends express.Router {
  ...
  constructor (options) {
    ...
    this.patch(/\/(.*)\/mv\/(.*)/, bodyParser.json(), (req, res) => {
    ...
    this.delete(/\/(.*)\/rm\//, bodyParser.json(), (req, res) => {
      let rmPromised = null;
    ...
    this.post(/\/(.*)\/cp\/(.*)/, bodyParser.json(), (req, res) => {
    ...
    this.post(/\/(.*)\/upload\/(.*)/, bodyParser.json(), upload.array('content'), (req, res) => {
