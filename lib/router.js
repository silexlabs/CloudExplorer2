...
function sessionFromHeaders(headers) {
  ...
  if(headers['UNIFILE_FTP_TOKEN']) headers['UNIFILE_FTP_PASSWORD'] = headers['UNIFILE_FTP_TOKEN']
  if(headers['UNIFILE_SFTP_TOKEN']) headers['UNIFILE_FTP_PASSWORD'] = headers['UNIFILE_SFTP_TOKEN']
